...
function placeXOrO (squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        let soundLink = '';
        if (activePlayer === 'X') {
            soundLink = './media/drawO.mp3';
        }
        else {
            soundLink = './media/drawX.mp3';
        }

        // This function plays placement sound.
        audio(soundLink);
        // This condition checks if it is computer's turn.
        if (activePlayer === 'O') {
    ...
    function computersTurn () {
        ...
        // trying is a square is selected already.
        while (!success) {
            // A random number between 0 and 8 is selected.
            pickASquare = String(Math.floor(Math.random()*9));
            // If the random number evaluates return true the hasn't been selected yet.
...
function checkWinConditions () {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        // The next 3 variables will be used to check for 3 on a row.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing () {
        // This variable creates the lop for when the game ends it restarts.
        ...
        c.lineTo(x, y);
        // This method set the width of the line.
        c.lineWidth = 10;
        // This method sets the color of our line.
        c.strokeStyle = '#bf6200';
    ...
    function clear () {
        ...
        c.clearRect(0, 0, 608, 608);
        // This lione stops our animation loop.
