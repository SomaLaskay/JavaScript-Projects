...
function openForm() {
    let cForm = document.getElementById("myForm").style;
    cForm.animation = "moveFormIN 1s ease-in";
    cForm.display = "block";
}

function closeForm() {
    let cForm = document.getElementById("myForm").style;
    cForm.animation = "moveFormOUT 1s ease-in";
    setTimeout(function() {cForm.display = "none"}, 1000);
