...
function Handle_Operator(Next_Operator) {
    ...
    // diplayed on the screen to a number and then store the result in
    ...
    if (First_Operand == null) {
        ...
        // If operator exists, porperty lookup is performed for the operator
        // in the Perform_Calculation object and the function that matches the
        // operator executed.
        let result = Perform_Calculation[operator] (Value_Now, Value_of_Input);
        // Here we add a fixxed amount of numbers after the decimal
